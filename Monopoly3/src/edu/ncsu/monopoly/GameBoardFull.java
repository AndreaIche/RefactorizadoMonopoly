...
public class GameBoardFull extends GameBoard {
	...
	public GameBoardFull() {
        ...
        IOwnable c1 = new CardCell(Card.typeChange, "Chance 1");
        ...
        IOwnable cc2 = new CardCell(Card.typeCc, "Community Chest 2");
        ...
        IOwnable c2 = new CardCell(Card.typeChange, "Chance 2");
        ...
        IOwnable cc3 = new CardCell(Card.typeCc, "Community Chest 3");
        PropertyCell g3 = new PropertyCell();
        RailRoadCell rr4 = new RailRoadCell();
        IOwnable c3 = new CardCell(Card.typeChange, "Chance 3");
        ...
        addCard(new MoneyCard("Win $50", 50, Card.typeCc));
        addCard(new MoneyCard("Win $20", 20, Card.typeCc));
        addCard(new MoneyCard("Win $10", 10, Card.typeCc));
        addCard(new MoneyCard("Lose $100", -100, Card.typeCc));
        addCard(new MoneyCard("Lose $50", -50, Card.typeCc));
        addCard(new JailCard(Card.typeCc));
        addCard(new MovePlayerCard("St. Charles Place", Card.typeCc));
        addCard(new MovePlayerCard("Boardwalk", Card.typeCc));

        addCard(new MoneyCard("Win $50", 50, Card.typeChange));
        addCard(new MoneyCard("Win $20", 20, Card.typeChange));
        addCard(new MoneyCard("Win $10", 10, Card.typeChange));
        addCard(new MoneyCard("Lose $100", -100, Card.typeChange));
        addCard(new MoneyCard("Lose $50", -50, Card.typeChange));
        addCard(new JailCard(Card.typeChange));
        addCard(new MovePlayerCard("Illinois Avenue", Card.typeChange));
